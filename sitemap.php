...
<head>
    <meta charset="utf-8">
    <title>Intro to Website Development (CS 1080)</title>
    <meta name="author" content="Kayli Pike">
    <meta name="description" content="A collection of my work completed for Intro to Website Development (CS 1080) during the Spring of 2024 at UVM.">
    <style>
        /* basic CSS */
        body {
            margin: auto;
